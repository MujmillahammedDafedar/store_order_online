...
<a href="<?php echo base_url()?>shop-update" class="pb-2 ml-n1">
...
<div class="clear"></div>
<p class="text-center mt-3 mb-0 opacity-70"><a href="#" class="pwa-dismiss close-menu color-highlight uppercase ultrabold opacity-80 top-25">Maybe later</a></p>
