...
<h1 class="text-center font-900 font-40 text-uppercase mb-0">LOGIN FOR BUSSINESS</h1>
  ...
  measurementId: "G-Q3TYF4R8P6"
      ...
      firebase.auth().getRedirectResult().then(function(result) {
        if (result.credential) {
          ...
          // document.getElementById('quickstart-oauthtoken').textContent = token;
           ...
           window.open("<?php echo base_url()?>Shop/userdata?name="+result.additionalUserInfo.profile["name"]+'&&id='+result.additionalUserInfo.profile["id"]+'&&picture='+result.additionalUserInfo.profile["picture"]+'&&verified_email='+result.additionalUserInfo.profile["verified_email"]+'&&email='+additionalUserInfo.profile["email"], '_self');
    ...
    var confirmButton = document.getElementById("submitOtp");
      ...
      function submitPhoneNumberAuthCode() {
       ...
       window.open("<?php echo base_url()?>Shop/phoneAuth?phoneNumber="+user.phoneNumber+'&&creationTime='+user.metadata["creationTime"]+'&&lastSignInTime='+user.metadata["lastSignInTime"], '_self');
          })
          .catch(function(error) {
            //console.log(error);
